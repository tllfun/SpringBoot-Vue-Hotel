<template>
  <div style="background-color: white;height: 100%">
    <div style="background-color: white;height: 100%">
      <br/>
      <el-text tag="i" style="float:left;margin-left: 30%">创建房间</el-text>
      <br/>
      <el-form ref="formRef" :model="form" label-width="120px" style="margin-top: 10px">
        <el-form-item label="room" :label-width="formLabelWidth" prop="room">
          <el-input style="width: 50%" v-model="form.room" autocomplete="off" />
        </el-form-item>
        <el-form-item label="type" :label-width="formLabelWidth" prop="type">
          <el-input style="width: 50%" v-model="form.type" autocomplete="off" />
        </el-form-item>
        <el-form-item label="floor" :label-width="formLabelWidth" prop="floor">
          <el-input style="width: 50%" v-model="form.floor" autocomplete="off" />
        </el-form-item>
        <el-form-item label="available" :label-width="formLabelWidth" prop="available">
          <el-input style="width: 50%" v-model="form.available" autocomplete="off" />
        </el-form-item>
        <el-form-item label="picture1" :label-width="formLabelWidth" prop="picture1">
          <el-input style="width: 50%" v-model="form.picture1" autocomplete="off" />
        </el-form-item>
        <el-form-item label="picture2" :label-width="formLabelWidth" prop="picture2">
          <el-input style="width: 50%" v-model="form.picture2" autocomplete="off" />
        </el-form-item>
        <el-form-item label="picture3" :label-width="formLabelWidth" prop="picture3">
          <el-input style="width: 50%" v-model="form.picture3" autocomplete="off" />
        </el-form-item>
        <el-form-item label="picture4" :label-width="formLabelWidth" prop="picture4">
          <el-input style="width: 50%" v-model="form.picture4" autocomplete="off" />
        </el-form-item>
